          ...
          <Row className="align-items-center gy-lg-0 gy-sm-5 gy-4">
            <Col lg={6}>
              <div className="section_heading mb-4 mb-sm-5 text-start">
                ...
                <p>
                  Don’t stress! This is fun! Now is the time to plan the
                  vacation of your dreams. Leave the planning to us.{" "}
                </p>
              </div>
              <div className="d-flex align-items-start mb-xl-5 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p>
                    Settled on a destination, or maybe even two? <br /> We will
                    get you closer to your planned holiday.
                  </p>
                </div>
              </div>
              <div className="d-flex align-items-start mb-xl-5 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <p>
                    Connect with our travel specialist to discuss your holiday
                    in depth.
                    <br /> We create a tailor-made journey as that is unique as
                    you are.
                  </p>
                </div>
              </div>
              <div className="d-flex align-items-start">
                ...
                <div className="flex-1">
                  ...
                  <p>
                    After the meeting, you’ll receive a special travel itinerary{" "}
                    <br />
                    to show your day-to-day journey like flights, car rentals
                    etc. <br />
                    Sign up with Unique Travel Crafters and we will begin taking
                ...
                <div className="p-3 bg-white booking_card shadow">
                  ...
                  <div>
                    ...
                    <div className="d-flex gap-3 mb-4">
                      <span className="d-flex align-items-center justify-content-center icon-item text-black-50 fs-6">
                        <FaLeaf />
                      </span>
                      <span className="d-flex align-items-center justify-content-center icon-item text-black-50 fs-6">
                        <FaMapMarkedAlt />
